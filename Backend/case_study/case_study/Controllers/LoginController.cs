...
namespace case_study.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public LoginController(CaseStudyContext context) { _context = context; }
...

        {
            ...
            var user = await _context.Contractors.FirstOrDefaultAsync(u => u.ContractorId == username);

            if (user != null)

            {

                if (password.Equals(user.ConPassword)) { return true; }
